...
## Using the batch tool to validate variants for submission to journals
...
**Errors in variant descriptions that are identified by VariantValidator (including
...
corresponds to the corrected variant descriptions.**
